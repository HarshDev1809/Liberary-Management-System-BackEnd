...
const { createBook,getBooks,getBookById, updateBookCount, updateBookDetails} = require("../Controllers/book.controller");
...
module.exports = (app)=>{
    ...
    app.put("/api/books/edit/:id",[verifyToken],updateBookDetails)
